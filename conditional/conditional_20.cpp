...
int main () {
	int picanha, alcatra, linguiça, espetinho, sal, farinha, carvao;
	float total, desconto, valorFinal;
	
	cin >> picanha >> alcatra >> linguiça >> espetinho >> sal >> farinha
	>> carvao;
	
	total = picanha*28.90 + alcatra*19.90 + linguiça*7.95 + espetinho*2.99
	+ sal* 1.50 + farinha*1.85 + carvao*8.70;
	...
	cout << fixed << setprecision(2) << total << endl << desconto <<
	endl << valorFinal;
